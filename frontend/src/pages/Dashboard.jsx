...
// import ResumeSummaryCard from "../components/ResumeSummaryCard"; // ✅ make sure this component exists
        ...
        <div className={styles.modalBackdrop}>
          <div className={styles.modalContent}>
            ...
            <div className="flex justify-end gap-4 mt-4">
              ...
              <button onClick={handleDeleteResume} className="text-red-600 font-semibold">
                Delete
              </button>
            </div>
          </div>
