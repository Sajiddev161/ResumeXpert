...
import Modal from "../components/Modal"; // ✅ Added missing import (Modal component)
...
const LandingPage = () => {
  ...
  const [currentPage, setCurrentPage] = useState("login"); // ✅ Added missing state
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-20 w-full">
            ...
            <div className="w-full md:w-1/1">
              ...
              <p className={landingPageStyles.description}>
                Create job-winning resumes effortlessly with ResumeXpert.
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            ...
            <a
              href="https://sajidkhan-portfolio.netlify.app/"
              target="_blank"
              rel="noreferrer"
